...
if($id_curso>1)
{
	//Bloque de información de los alumnos del curso
	$u=newObject("alumno_curso");
	...
	//Bloque de información de los docentes que imparten clase en el curso
	...
	//echo "nº cuestionarios=".$e->num_cuest." no_alumnos=".$u->no_alumnos;
	listList($e,$d,'Informe_fpo/expertosPDF_fpo');
	
	
	
	
	//Bloque de valoración de los módulos 
