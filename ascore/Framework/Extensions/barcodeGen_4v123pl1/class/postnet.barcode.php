 ...
 *--------------------------------------------------------------------
 * $Id: postnet.barcode.php,v 1.1 2007/05/17 16:33:06 actsys Exp $
 * PHP5-Revision: 1.7
 *--------------------------------------------------------------------
...
class postnet extends BarCode {
	 ...
	 */
	function postnet($maxHeight, &$color1, &$color2, $res, $text, $textfont) {
	 ...
	 * @param int $last
	 */
	function DrawChar(&$im, $code, $last = 0) {
