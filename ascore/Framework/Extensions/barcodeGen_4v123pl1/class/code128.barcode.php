 ...
 *--------------------------------------------------------------------
 * $Id: code128.barcode.php,v 1.1 2007/05/17 16:33:06 actsys Exp $
 * PHP5-Revision: 1.11
 *--------------------------------------------------------------------
...
class code128 extends BarCode {
	var $keys = array(), $keysA = array(), $keysB = array(), $keysC = array(), $code = array();
	var $starting, $ending, $starting_text;
	var $currentCode;
	 ...
	 * @param char $start
	 */
	function code128($maxHeight, &$color1, &$color2, $res, $text, $textfont, $start = 'B') {
