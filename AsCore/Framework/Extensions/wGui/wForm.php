  ...
  class wForm extends wObject implements wRenderizable {
    ...
    function render() {
      ...
      foreach ($this->wChildren as $c) {
        ...
        $count++;
        if ($count%2==0) {
          echo "<div style='float:left;width:73%;padding:2px'>";$c->render();echo '</div>';
        }
        else {
          echo "<div style='float:left;width:25%;min-width:175px;border:1px;padding:2px'>";$c->render();echo '</div>';
        }
